				...
				<div class="ber_settings_form">
					...
					<form method="post">
						...
						<div class="ber_form">
						    ...
						    <?php if($plugin_type && $plugin_type != 'pro') { ?>
						    <div class="ber_form_group ber_monthly_upgrade">
								<a target="_blank" href="https://bertha.ai/checkout/?edd_action=add_to_cart&download_id=835&edd_options%5Bprice_id%5D=24" class="ber_button monthly_upgrade">Upgrade to Monthly $20.00</a>
								<p>1 Million words a month & 50 image credits</p>
							</div>
							<div class="ber_form_group ber_monthly_upgrade">
								<a target="_blank" href="https://bertha.ai/checkout/?edd_action=add_to_cart&download_id=835&edd_options%5Bprice_id%5D=33" class="ber_button monthly_upgrade">Upgrade to Annual $160.00</a>
							</div>
							<?php } ?>
						</div>
					</form>
	...
	function bthai_license_cb() {
		...
		if($plugin_type && $plugin_type != 'pro') {
			echo '<div class="ber_form_group ber_monthly_upgrade">
						<a target="_blank" href="https://bertha.ai/checkout/?edd_action=add_to_cart&download_id=835&edd_options%5Bprice_id%5D=24" class="ber_button monthly_upgrade">'.__('Upgrade to Monthly $20.00', 'bertha-ai').'</a>
						<p>1 Million words a month & 50 image credits</p>
					</div>';
			echo '<div class="ber_form_group ber_monthly_upgrade">
						<a target="_blank" href="https://bertha.ai/checkout/?edd_action=add_to_cart&download_id=835&edd_options%5Bprice_id%5D=33" class="ber_button monthly_upgrade">'.__('Upgrade to Annual $160.00', 'bertha-ai').'</a>
					</div>
