...
<p><?php esc_html_e('No results.', 'brandium');?></p>
<!-- /wp:paragraph -->
<!-- /wp:query-no-results -->
...
<h4 class="wp-block-heading"><?php esc_html_e('Search', 'brandium');?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php esc_html_e('Latest Posts', 'brandium');?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php esc_html_e('Categories', 'brandium');?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php esc_html_e('Tags', 'brandium');?></h4>
<!-- /wp:heading -->
